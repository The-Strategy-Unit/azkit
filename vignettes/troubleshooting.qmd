...
difficulty.
To debug initially, try running:
...
You may wish to use the Azure Portal website or the Azure Storage Explorer app
to check that you have a valid container name and file path.
