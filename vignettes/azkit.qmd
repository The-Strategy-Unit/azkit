...
azkit::read_azure_csv(azkit::get_container(container_name = "supporting-data",
                             endpoint_url = Sys.getenv("AZ_STORAGE_EP")),
...
azkit::get_container(
  ...
  azkit::read_azure_csv(file = "mitigator-lookup.csv",
...
azkit::read_azure_file(azkit::get_container(container_name = "supporting-data",
                             endpoint_url = Sys.getenv("AZ_STORAGE_EP")),
               file = "mitigator-lookup.csv")
```
...
```{r}
raw_data <- azkit::read_azure_file(azkit::get_container(container_name = "supporting-data",
                             endpoint_url = Sys.getenv("AZ_STORAGE_EP")),
               file = "mitigator-lookup.csv")
...
list_of_csvs |> 
   ...
   purrr::map(\(x) {
    read_azure_csv(
      azkit::get_container(container_name = "supporting-data", 
                           endpoint_url = Sys.getenv("AZ_STORAGE_EP")),
      x
    )
  }) |>
